...
var author$project$Main$channelPanel = F2(
	function (channels, activeChannel) {
		...
		var channelEl = function (channel) {
			return A2(
				mdgriffith$elm_ui$Element$el,
				_Utils_eq(channel, activeChannel) ? _Utils_ap(activeChannelAttrs, channelAttrs) : channelAttrs,
		...
		return A2(
			...
			A2(elm$core$List$map, channelEl, channels));
	});
...
var author$project$Main$chatPanel = F2(
	function (channel, messages) {
		var messageEntry = function (message) {
			return A2(
				mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[mdgriffith$elm_ui$Element$Font$bold]),
								mdgriffith$elm_ui$Element$text(message.author)),
								mdgriffith$elm_ui$Element$text(message.time)
							])),
						A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(message.text)
							]))
					]));
		};
		var messagePanel = A2(
			...
			A2(elm$core$List$map, messageEntry, messages));
		var header = A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
		...
		var footer = A2(
			...
			A2(
				...
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Element$spacingXY, 2, 0),
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
...
var author$project$Main$main = function () {
	var messages = _List_fromArray(
		[
			{author: 'Rémy', text: 'Je vais faire un test avec elm-ui 🕴', time: '12:57'},
			{author: 'Greg', text: 'N\'y passe pas trop de temps on va attendre Janvier pour en discuter 🙊', time: '13:07'},
			{author: 'Yannick', text: 'Plus il y a de @elmlang mieux c\'est de toute manière 😎', time: '13:17'},
			{author: 'Greg', text: 'Ça ne t\'empêche pas de regarder elm-ui 🚎', time: '13:18'},
			{author: 'Rémy', text: 'Mon objectif c\'est d\'avoir quelques mockup pour valider que ce que j\'ai compris fonctionne ', time: '13:19'},
			{author: 'Rémy', text: 'Je suis un codeur pas un designer du coup je sais pas faire des mockups sans coder 😢', time: '13:19'}
		]);
	var channel = 'tech';
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					A2(
					author$project$Main$channelPanel,
					_List_fromArray(
						['general', 'tech', 'manger', 'noël']),
					channel),
					A2(author$project$Main$chatPanel, channel, messages)
				])));
}();
